...
from main.data_engineer.frontend.dashboard.content.cards.card_table_school import COLUMN_LABELS
...
def card_regional_table(df, mode):
    ...
    return html.Div(
        ...
        children=[
            html.Div("ENROLLMENT SUMMARY PER REGION", className="card-title"),
            html.Div([
                dcc.Input(
                ...
                dash_table.DataTable(
                    ...
                    columns=[{"name": column_labels.get(col, col.replace("_", " ").title()), "id": col}

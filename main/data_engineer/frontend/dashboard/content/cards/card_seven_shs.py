...
def card_seven_shs(df, mode):
    ...
    def create_area_chart(x_labels, male_data, female_data, title):
        ...
        fig.add_trace(go.Scatter(
            ...
            fill='tozeroy', mode='lines+markers',  # Add markers
        ...
        fig.update_layout(
            ...
            xaxis=dict(
                ...
                linecolor='black',
                tickmode='array',
                tickvals=x_labels  # Ensure all x-values show
            ),
            yaxis=dict(
                showline=True,
                linecolor='black',
                tickvals=[1, 10, 100, 1000, 10000, 100000],  # Skip 2, 5
    ...
    return html.Div([
        html.Div([
            html.Div("ENROLLMENT DISTRIBUTION (STRANDS)", className='card-title-main'),

...
def card_seven_es(df, mode):
    ...
    def create_area_chart(x_labels, male_data, female_data, title):
        ...
        fig.add_trace(go.Scatter(
            ...
            fill='tozeroy', mode='lines+markers',  # 👈 Added markers
    ...
    return html.Div([
        html.Div([
            html.Div("ENROLLMENT DISTRIBUTION (KINDER - GRADE 6)", className='card-title-main'),
    ...
    ], className="card card-seven es")

def card_seven_es_register_callbacks(app):
    return None